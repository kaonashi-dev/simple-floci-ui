	...
	const services = $derived([
		{
			...
			count: data.counts.sqs?.count ?? null,
			error: data.counts.sqs?.error ?? null,
			unit: 'queue',
		...
		},
		{
			...
			count: data.counts.s3?.count ?? null,
			error: data.counts.s3?.error ?? null,
			unit: 'bucket',
			icon: HardDriveIcon
		},
		{
			...
			count: data.counts.cognito?.count ?? null,
			error: data.counts.cognito?.error ?? null,
			unit: 'pool',
			icon: UsersRoundIcon
		},
		{
			...
			count: data.counts.kms?.count ?? null,
			error: data.counts.kms?.error ?? null,
			unit: 'key',
			icon: KeyRoundIcon
		},
		{
			...
			count: data.counts.lambda?.count ?? null,
			error: data.counts.lambda?.error ?? null,
			unit: 'function',
			icon: SigmaIcon
		},
		{
			...
			count: data.counts.dynamodb?.count ?? null,
			error: data.counts.dynamodb?.error ?? null,
			unit: 'table',
			icon: DatabaseIcon
		},
		{
			...
			count: data.counts.sns?.count ?? null,
			error: data.counts.sns?.error ?? null,
			unit: 'topic',
			icon: RadioTowerIcon
		},
		{
			...
			count: data.counts.apigateway?.count ?? null,
			error: data.counts.apigateway?.error ?? null,
			unit: 'REST API',
			icon: NetworkIcon
		},
		{
			...
			count: data.counts.iam?.count ?? null,
			error: data.counts.iam?.error ?? null,
			unit: 'user',
			icon: ShieldIcon
		},
		{
			...
			count: data.counts.logs?.count ?? null,
			error: data.counts.logs?.error ?? null,
			unit: 'log group',
			icon: ScrollTextIcon
		},
		{
			...
			count: data.counts.eventbridge?.count ?? null,
			error: data.counts.eventbridge?.error ?? null,
			unit: 'bus',
			icon: ZapIcon
		},
		{
			...
			count: data.counts.secrets?.count ?? null,
			error: data.counts.secrets?.error ?? null,
			unit: 'secret',
			icon: LockIcon
		},
		{
			...
			count: data.counts.ssm?.count ?? null,
			error: data.counts.ssm?.error ?? null,
			unit: 'parameter',
			icon: SlidersIcon
		}
	]);

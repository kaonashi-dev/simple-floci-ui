						...
						<tr class="border-b border-border/40 last:border-0 hover:bg-muted/20 transition-colors">
							<td class="px-4 py-3">
								<div class="space-y-1">
									<div class="flex items-center gap-1.5">
										<a href="/aws/kms/{encodeURIComponent(key.keyId)}" class="font-mono text-xs font-medium text-foreground transition-colors hover:text-primary">
											{key.keyId}
										</a>
							...
							<td class="px-4 py-3 text-right">
								<div class="flex items-center justify-end gap-1">
									<Button variant="ghost" size="sm" class="h-7 px-2 text-xs" href="/aws/kms/{encodeURIComponent(key.keyId)}">
										Open
									</Button>
